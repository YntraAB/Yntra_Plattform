...
const YntraLogo: React.FC = () => (
  <div className="mb-6 flex items-center justify-center">
    ...
    <span className="ml-2 text-2xl font-bold text-foreground" data-testid="yntra-logo">
      Yntra
    </span>
  </div>
)
      ...
      <div className="flex flex-1 items-center justify-center px-4 py-12">
        <div className="animate-fade-in w-full max-w-md">
          <div className="mb-10 text-center">
            <YntraLogo />
            <h1 className="mb-2 text-3xl font-bold text-foreground">{t('auth.login.title')}</h1>
